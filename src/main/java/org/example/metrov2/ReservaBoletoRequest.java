 ...
 *       &lt;sequence>
 *         &lt;element name="FechaPartida" type="{http://www.w3.org/2001/XMLSchema}date"/>
...
@XmlRootElement(name = "ReservaBoletoRequest")
public class ReservaBoletoRequest {

    @XmlElement(name = "FechaPartida", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar fechaPartida;
    @XmlElement(name = "EstacionOrigen", required = true)
    protected String estacionOrigen;
    @XmlElement(name = "EstacionDestino", required = true)
    protected String estacionDestino;
    @XmlElement(name = "ElegirVagon", required = true)
    protected String elegirVagon;
    @XmlElement(name = "IngresaMetodoPago", required = true)
     ...
     *     
     */
    public void setFechaPartida(XMLGregorianCalendar value) {
